...
See [Rate Limiting](https://developers.cloudflare.com/workers/runtime-apis/bindings/rate-limit/) for namespace semantics and [`docs/decisions/marktplaats.md`](../decisions/marktplaats.md) for the source, location-resolution and cursor model.
