...
- 357821b: Translate the groceries MCP to Dutch. The MCP title and description, every
  operation title and description, and all four tool content files are now
  Dutch, matching the language of the site that documents them.
